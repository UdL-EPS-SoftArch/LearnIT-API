Feature: Create a question
  ...
  Scenario: Add a question as teacher with empty answer
    ...
    Then The response code is 400
    And It has not been created a question with statement "statement test" and answer ""//ask here
  ...
  Scenario: Add a question as teacher with empty level
    ...
    Then The response code is 400
    And It has not been created a question with statement "statement test"//ask here
